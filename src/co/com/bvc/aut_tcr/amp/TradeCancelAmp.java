package co.com.bvc.aut_tcr.amp;
...
public class TradeCancelAmp {
	...
	public static boolean tradeCancelApprove(String user, String password, String trMatchId) {
		...
		long tradeNo = Long.parseLong(trMatchId.substring(trMatchId.length() - 4));
		...
		try {
			Session session = disposer.disposes(SessionFactory.create_session("resources/configAmp.ini"));
	 ...
	 * @param tradeNoSuffix
	 */
	public static boolean tradeCancelReject(String user, String password, String trMatchId) {
