...
import co.com.bvc.aut_tcr.orquestador.AdapterIO;
...
public class BasicFunctions {
	...
	private static int ampDcvDecition;
	private static boolean lastAE = false;
	
	public static boolean isLastAE() {
		return lastAE;
	}

	public static void setLastAE(boolean lastAE) {
		BasicFunctions.lastAE = lastAE;
	}

	public static int getAmpDcvDecition() {
		return ampDcvDecition;
	}

	public static void setAmpDcvDecition(int ampDcvDecition) {
		BasicFunctions.ampDcvDecition = ampDcvDecition;
	}
